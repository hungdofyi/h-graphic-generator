...
- Exception: Acronyms like API, SQL, CSS are proper nouns
...
### Styling
- **No raw hex colors** - Use brand tokens (green.300, green.600, etc.)
- **No mixed styles** - This is marketing style, don't mix with docs patterns
- **No inconsistent radii** - Keep border radius consistent throughout
